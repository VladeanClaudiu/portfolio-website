export default function ContactForm(props) {
    ...
    return (
        <section>
            ...
            <p>
                Dont hesitate to message me, I can be reached very easily. Fill in the from below to email at <span className={`${props.darkMode ? "span-underline-lightMode underlineLightmode" : "span-underline underlineDarkmode"}`}>claudiuver1.0@gmail.com </span>. 
            </p>
